  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 relative z-10">
      ...
      >
        ...
        <button
          type="submit"
          className="mt-2 w-full h-11 rounded-full text-white bg-amber-600 hover:bg-amber-500 transition "
        >
          {state === 'login' ? 'Login' : 'Sign up'}
        </button>
      ...
      <div className="fixed inset-0 -z-1 pointer-events-none">
        <div className="absolute left-1/2 top-20 -translate-x-1/2 w-245 h-115 bg-linear-to-tr from-amber-400/40 to-transparent rounded-full blur-3xl" />
        <div className="absolute right-12 bottom-5 w-105 h-55 bg-linear-to-bl from-amber-500/35 to-transparent rounded-full blur-2xl" />
      </div>
    </div>
  );
};
