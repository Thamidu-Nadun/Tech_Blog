    ...
    <div className="h-dvh flex justify-center items-center">
      <div className="container flex flex-col text-center justify-center items-center text-white -translate-y-14">
        ...
        <p className="my-4 md:text-xl text-md leading-5 mx-5">
          Hi, I'm
          {' '}
          <span className="font-caveat">Thamidu Nadun</span>
          , a developer sharing insights about modern development
          , emerging technologies, and practical coding solutions, exploitations. Join me on this journey through the ever-evolving world of tech.
        </p>
