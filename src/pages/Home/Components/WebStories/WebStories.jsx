...
function WebStories() {
  const webStories = [
    ...
    },
    {
      ...
      thumbnail:
        "https://images.unsplash.com/photo-1517180102446-f3ece451e9d8?w=300&h=400&fit=crop",
      views: "8.2K",
      pages: 6,
      type: "Comparison",
    },
    ...
    },
    {
      ...
      thumbnail:
        "https://images.unsplash.com/photo-1605745341112-85968b19335b?w=300&h=400&fit=crop",
      views: "9.8K",
      pages: 5,
      type: "Quick Tips",
    },
