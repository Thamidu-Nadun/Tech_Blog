...
function ArticleCard({
  ...
  return (
    <div
      className="bg-gradient-to-b from-black/80 via-transparent to-black/80 h-84 rounded-xl relative group bg-cover bg-center w-full"
      style={{
        backgroundImage: `
    ...
    >
      <div className="absolute bottom-5 px-5 bg-gradient-to-b from--transparent to-black/80 to-90% group-hover:to-60% transition-all duration-300">
        <TagButton
