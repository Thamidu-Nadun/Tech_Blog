    ...
    return (
        <nav className="h-20 w-full px-6 md:px-16 lg:px-24 xl:px-32 flex items-center justify-between z-50 text-white transition-all sticky-top">
            ...
            <ul className="md:flex hidden items-center gap-10 text-md">
                ...
                <li><a className="hover:text-orange-400 transition" href="#">Services</a></li>
                <li><a className="hover:text-orange-400 transition" href="#">Portfolio</a></li>
                <li><a className="hover:text-orange-400 transition" href="#">Pricing</a></li>
            </ul>

            <div className='flex gap-3'>
                <button className="px-4 py-2 rounded-2xl text-white hidden md:block border border-orange-400 hover:scale-105 transition-all duration-300">Log In</button>
                <button className="px-4 py-2 rounded-2xl text-white hidden md:block bg-gradient-to-r from-orange-600 to-orange-400 hover:scale-105 transition-all duration-300">Sign Up</button>
          </div> 
            <button
                aria-label="menu-btn"
                type="button"
            ...
            {isMobileMenuOpen && (
                <div className="fixed inset-0 z-40 bg-black bg-opacity-50 flex md:hidden">
                    <div
                        ref={mobileMenuRef}
                        className={`flex justify-center items-center bg-white text-black w-3/4 h-screen p-6 transform transition-transform duration-1000 ease-in-out ${
